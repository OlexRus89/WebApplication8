...
namespace WebApplication8.Controllers
{
    ...
    public class LeadController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,FirstName,MiddleName,Mobile,Email,Source")] SalesLeadEntity salesLeadEntity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,FirstName,MiddleName,Mobile,Email,Source")] SalesLeadEntity salesLeadEntity)
        {
